...
export default function ProfessionalDetails() {
    const [projectTypes, setProjectTypes] = useState(['Residential']);
    const [teamSize, setTeamSize] = useState('Solo');
    const [tools, setTools] = useState(['Power Tools', 'Ladders & Scaffolding', 'Hand Tools']);
    ...
    const handleSaveAndContinue = () => {
        ...
        console.log({ projectTypes, teamSize, tools });
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white min-h-screen flex flex-col font-display">
            ...
            <header className="sticky top-0 z-10 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-md">
            ...
            <main className="flex-1 overflow-y-auto pb-32">
                ...
                ${projectTypes.includes('Residential')
                                    ? 'border-primary bg-primary/5'
                                    : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50'}`}
                        >
                            <div className={`size-14 rounded-full flex items-center justify-center ${projectTypes.includes('Residential') ? 'bg-primary/20' : 'bg-slate-100 dark:bg-slate-800'}`}>
                                <span className={`material-symbols-outlined text-3xl ${projectTypes.includes('Residential') ? 'text-primary' : 'text-slate-400'}`}>home</span>
                            </div>
                        ...
                        <button
                            ...
                            className={`relative flex flex-col items-center justify-center gap-4 rounded-xl border-2 p-6 transition-all active:scale-95
                ${projectTypes.includes('Commercial')
                                    ? 'border-primary bg-primary/5'
                                    : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50'}`}
                        >
                            <div className={`size-14 rounded-full flex items-center justify-center ${projectTypes.includes('Commercial') ? 'bg-primary/20' : 'bg-slate-100 dark:bg-slate-800'}`}>
                                <span className={`material-symbols-outlined text-3xl ${projectTypes.includes('Commercial') ? 'text-primary' : 'text-slate-400'}`}>domain</span>
                            </div>
                ...
                ${teamSize === 'Solo'
                        ...
                        >
                            ...
                            <div className={`size-6 rounded-full flex items-center justify-center ${teamSize === 'Solo' ? 'bg-primary' : 'border-2 border-slate-300 dark:border-slate-700'}`}>
                                {teamSize === 'Solo' && <div className="size-2.5 bg-white rounded-full"></div>}
                            </div>
                        </button>
                        {/* Small Team */}
                        <button
                ...
                ${teamSize === 'Small'
                        ...
                        >
                            ...
                            <div className={`size-6 rounded-full flex items-center justify-center ${teamSize === 'Small' ? 'bg-primary' : 'border-2 border-slate-300 dark:border-slate-700'}`}>
                                {teamSize === 'Small' && <div className="size-2.5 bg-white rounded-full"></div>}
                            </div>
                        </button>
                        {/* Large Crew */}
                        <button
                ...
                ${teamSize === 'Large'
                        ...
                        >
                            ...
                            <div className={`size-6 rounded-full flex items-center justify-center ${teamSize === 'Large' ? 'bg-primary' : 'border-2 border-slate-300 dark:border-slate-700'}`}>
                                {teamSize === 'Large' && <div className="size-2.5 bg-white rounded-full"></div>}
                            </div>
                        </button>
                    </div>
                </section>
            ...
            {/* Bottom Action Bar */}
            <footer className="fixed bottom-0 left-0 right-0 p-4 bg-background-light dark:bg-background-dark border-t border-slate-200 dark:border-slate-800 flex flex-col gap-3">
                <button
